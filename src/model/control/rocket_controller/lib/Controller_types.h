...
#ifndef DEFINED_TYPEDEF_FOR_struct_AtpMUMXHQ4EpFICCggTZNH_
#define DEFINED_TYPEDEF_FOR_struct_AtpMUMXHQ4EpFICCggTZNH_

typedef struct {
  uint32_T period;
  int8_T model_info[25];
} struct_AtpMUMXHQ4EpFICCggTZNH;

#endif

#ifndef DEFINED_TYPEDEF_FOR_struct_3zLBZv1DafkAI5Ov6R3JHD_
#define DEFINED_TYPEDEF_FOR_struct_3zLBZv1DafkAI5Ov6R3JHD_
...
typedef struct {
  ...
  real32_T SERVO1_SCALE;
  real32_T SERVO2_SCALE;
  real32_T SERVO3_SCALE;
  real32_T SERVO4_SCALE;
} struct_3zLBZv1DafkAI5Ov6R3JHD;
