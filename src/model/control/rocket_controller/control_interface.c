...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(VEL_XY_P, 1.6, false),
    ...
    PARAM_FLOAT(VEL_Z_I_MIN, -0.25, false),
    PARAM_FLOAT(VEL_Z_I_MAX, 0.25, false),
    PARAM_FLOAT(VEL_Z_D_MIN, -0.1, false),
    PARAM_FLOAT(VEL_Z_D_MAX, 0.1, false),
    PARAM_FLOAT(ROLL_P, 7, false),
    PARAM_FLOAT(PITCH_P, 7, false),
    PARAM_FLOAT(ROLL_PITCH_CMD_LIM, 0.26, false),
    PARAM_FLOAT(ROLL_RATE_P, 0.5, false),
    PARAM_FLOAT(PITCH_RATE_P, 0.5, false),
    PARAM_FLOAT(YAW_RATE_P, 0.115, false),
    PARAM_FLOAT(ROLL_RATE_I, 0.08, false),
    PARAM_FLOAT(PITCH_RATE_I, 0.08, false),
    PARAM_FLOAT(YAW_RATE_I, 0.13, false),
    PARAM_FLOAT(ROLL_RATE_D, 0.002, false),
    PARAM_FLOAT(PITCH_RATE_D, 0.002, false),
    PARAM_FLOAT(YAW_RATE_D, 0.002, false),
    ...
    PARAM_FLOAT(HOVER_THRO, 0.75, false),
    PARAM_FLOAT(SERVO1_BIAS,90.0,false),
    PARAM_FLOAT(SERVO2_BIAS,0.0,false),
    PARAM_FLOAT(SERVO3_BIAS,40.0,false),
    PARAM_FLOAT(SERVO4_BIAS,-20.0,false),
    PARAM_FLOAT(SERVO1_SCALE,1.0,false),
    PARAM_FLOAT(SERVO2_SCALE,1.0,false),
    PARAM_FLOAT(SERVO3_SCALE,1.0,false),
    PARAM_FLOAT(SERVO4_SCALE,1.0,false)
};
...
static void init_parameter(void)
{
    ...
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, SERVO1_SCALE), &CONTROL_PARAM.SERVO1_SCALE));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, SERVO2_SCALE), &CONTROL_PARAM.SERVO2_SCALE));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, SERVO3_SCALE), &CONTROL_PARAM.SERVO3_SCALE));
    FMT_CHECK(param_link_variable(PARAM_GET(CONTROL, SERVO4_SCALE), &CONTROL_PARAM.SERVO4_SCALE));
}
