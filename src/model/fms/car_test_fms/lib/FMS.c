     ...
     case 0:
      ...
      switch (FMS_DW.SwitchCase_ActiveSubsystem_a) {
       case 0:
        ...
        if (rtb_Integrator1_b <= 0.0F) {
          ...
          if (rtb_Gain_cl >= 0.0F) {
            ...
            if (rtb_FixPtRelationalOperator) {
              ...
              rtb_Divide_aj[1] = B * rtb_TmpSignalConversionAtMath_0 +
                FMS_DW.Delay_DSTATE_f[1];
            }
          }
         ...
         *  Math: '<S144>/Math Function'
         */
        B = rtb_P_i_idx_0 + rtb_TmpSignalConversionAtMath_0;
         ...
         */
        if (B < 0.0F) {
          rtb_Integrator1_b = -sqrtf(fabsf(B));
        } else {
          rtb_Integrator1_b = sqrtf(B);
        }
        ...
        D = rtb_Switch_h[1] / rtb_Switch_h[2];
         ...
         */
        B = D * D + rtb_TmpSignalConversionAtMath_0 *
          rtb_TmpSignalConversionAtMath_0;
         ...
         */
        rtb_Integrator1_b = rtb_TmpSignalConversionAtMath_0 * rtb_Gain_cl - D *
          rtb_Divide_aj[0];
        ...
        rtb_Integrator1_b = (sqrtf((8.0F * fabsf(rtb_Gain) + FMS_ConstB.d_l) *
          FMS_ConstB.d_l) - FMS_ConstB.d_l) * 0.5F * rtb_Switch_f_idx_2 +
          rtb_Switch_f_idx_1;
         ...
         *  Sum: '<S132>/Subtract2'
         */
        rtb_Integrator1_b += (rtb_Gain_cl - rtb_Gain) * 0.5F *
          rtb_Switch_f_idx_1;
        ...
        /* Sum: '<S132>/Subtract3' */
        rtb_Gain_cl = rtb_Integrator1_b - FMS_ConstB.d_l;
        ...
        FMS_DW.Integrator_DSTATE_c += ((rtb_Integrator1_b / FMS_ConstB.d_l -
          rtb_Gain) * FMS_ConstB.Gain4_i * ((B - rtb_Gain_cl) * 0.5F) -
     ...
     case 1:
      ...
      switch (FMS_DW.SwitchCase_ActiveSubsystem_i) {
       case 0:
         ...
         */
        /* Outputs for Atomic SubSystem: '<S4>/FMS_Input' */
        /* S-Function (sfix_bitop): '<S116>/u_cmd valid' incorporates:
         *  Inport: '<Root>/Auto_Cmd'
         *  S-Function (sfix_bitop): '<S107>/u_cmd'
         ...
         *  S-Function (sfix_bitop): '<S116>/u_cmd valid'
         */
        rtb_FixPtRelationalOperator = (rtb_Compare_iv_tmp > 0U);

        /* Outputs for Atomic SubSystem: '<S4>/FMS_Input' */
        /* MultiPortSwitch: '<S108>/Index Vector' incorporates:
         *  Inport: '<Root>/Auto_Cmd'
        ...
        /* End of MultiPortSwitch: '<S108>/Index Vector' */
        /* End of Outputs for SubSystem: '<S4>/FMS_Input' */
         ...
         *  S-Function (sfix_bitop): '<S107>/psi_rate_cmd'
         *  SignalConversion: '<S26>/Signal Copy'
         *  Sum: '<S107>/Add'
         */
        ...
        /* Outputs for Atomic SubSystem: '<S107>/psi_rate_cmd_valid' */
        /* Outputs for Atomic SubSystem: '<S107>/u_cmd_valid' */
        FMS_Y.FMS_Out.cmd_mask = (uint16_T)((uint32_T)(((FMS_U.Auto_Cmd.cmd_mask
          & 64U) > 0U) << 5) + ((rtb_Compare_iv_tmp > 0U) << 6));

        /* End of Outputs for SubSystem: '<S107>/u_cmd_valid' */
        /* End of Outputs for SubSystem: '<S107>/psi_rate_cmd_valid' */
        /* End of Outputs for SubSystem: '<S4>/FMS_Input' */
       ...
       case 1:
         ...
         *  ActionPort: '<S84>/Action Port'
         */
        /* Outputs for Atomic SubSystem: '<S84>/Mission_SubSystem' */
        /* Outputs for Atomic SubSystem: '<S4>/FMS_Input' */
        ...
        rtb_TmpSignalConversionAtMath_0 = rtb_MathFunction_k[0] -
          FMS_U.INS_Out.x_R;
        D = rtb_MathFunction_k[1] - FMS_U.INS_Out.y_R;
        ...
        /* Update for DiscreteIntegrator: '<S88>/Integrator1' incorporates:
         *  DiscreteIntegrator: '<S88>/Integrator'
         */
         ...
         *  Product: '<S91>/Multiply6'
         *  Sum: '<S91>/Subtract4'
         *  Sum: '<S91>/Subtract5'
         *  Sum: '<S91>/Subtract6'
         */
        FMS_DW.Integrator_DSTATE += ((rtb_Gain / FMS_ConstB.d -
          rtb_Switch_f_idx_1) * FMS_ConstB.Gain4 * ((B - rtb_Gain_cl) * 0.5F) -
          rtb_Switch_f_idx_2 * 19.612F) * 0.01F;

        /* End of Outputs for SubSystem: '<S84>/Mission_SubSystem' */
       ...
       case 1:
        ...
        switch (FMS_DW.SwitchCase_ActiveSubsystem_d) {
         case 0:
           ...
           *  SignalConversion: '<S26>/Signal Copy1'
           */
          rtb_Switch_f_idx_1 = rtb_Switch_f_idx_0 * FMS_U.INS_Out.vn;
          rtb_Switch_f_idx_2 = rtb_Switch_f_idx_0 * FMS_U.INS_Out.ve;
           ...
           *  Math: '<S55>/Square'
           */
          rtb_Integrator1_b = rtb_Switch_f_idx_1 * rtb_Switch_f_idx_1;
          rtb_Gain = rtb_Switch_f_idx_2 * rtb_Switch_f_idx_2;

          /* Sum: '<S57>/Sum of Elements' incorporates:
           *  Math: '<S57>/Math Function'
           */
          rtb_P_i_idx_0 = rtb_Integrator1_b + rtb_Gain;
           ...
           */
          if (rtb_P_i_idx_0 < 0.0F) {
            rtb_Switch_f_idx_0 = -sqrtf(fabsf(rtb_P_i_idx_0));
          } else {
            rtb_Switch_f_idx_0 = sqrtf(rtb_P_i_idx_0);
          }
          ...
          if (rtb_Switch_f_idx_0 > 0.0F) {
            rtb_Switch_h[0] = rtb_Switch_f_idx_1;
            rtb_Switch_h[1] = rtb_Switch_f_idx_2;
            rtb_Switch_h[2] = rtb_Switch_f_idx_0;
          } else {
            rtb_Switch_h[0] = 0.0F;
            rtb_Switch_h[1] = 0.0F;
            rtb_Switch_h[2] = 1.0F;
           ...
           */
          rtb_P_i_idx_0 = FMS_DW.start_vel_DSTATE[0] * FMS_DW.start_vel_DSTATE[0]
          ...
          rtb_TmpSignalConversionAtMath_0 = FMS_DW.start_wp_DSTATE[0] -
            FMS_U.INS_Out.x_R;
          D = FMS_DW.start_wp_DSTATE[1] - FMS_U.INS_Out.y_R;
          ...
          B = rtb_Switch_f_idx_0 * rtb_TmpSignalConversionAtMath_0;
          ...
          /* Outputs for Atomic SubSystem: '<S4>/FMS_Input' */
          B = fabsf((rtb_Switch_f_idx_1 * rtb_P_i_idx_0 +
                     FMS_DW.start_wp_DSTATE[0]) - FMS_U.INS_Out.x_R);
          ...
          if (B > 1.29246971E-26F) {
            ...
            rtb_TmpSignalConversionAtMath_0 = B / 1.29246971E-26F;
            D = rtb_TmpSignalConversionAtMath_0 *
              rtb_TmpSignalConversionAtMath_0;
          }

          /* Outputs for Atomic SubSystem: '<S4>/FMS_Input' */
          B = fabsf((rtb_Switch_f_idx_1 * rtb_Switch_f_idx_0 +
                     FMS_DW.start_wp_DSTATE[1]) - FMS_U.INS_Out.y_R);

          /* End of Outputs for SubSystem: '<S4>/FMS_Input' */
          if (B > rtb_Switch_f_idx_2) {
            rtb_TmpSignalConversionAtMath_0 = rtb_Switch_f_idx_2 / B;
            D = D * rtb_TmpSignalConversionAtMath_0 *
              rtb_TmpSignalConversionAtMath_0 + 1.0F;
            rtb_Switch_f_idx_2 = B;
          } else {
            rtb_TmpSignalConversionAtMath_0 = B / rtb_Switch_f_idx_2;
            D += rtb_TmpSignalConversionAtMath_0 *
              rtb_TmpSignalConversionAtMath_0;
          }

          D = rtb_Switch_f_idx_2 * sqrtf(D);
          rtb_Switch_f_idx_2 = D * 0.577350259F + rtb_Switch_f_idx_1;
           ...
           *  Math: '<S56>/Square'
           */
          rtb_P_i_idx_0 = rtb_Switch_f_idx_1 * rtb_Switch_f_idx_1;
           ...
           */
          B = rtb_Divide_aj[1] * rtb_Divide_aj[1] + rtb_Divide_aj[0] *
            rtb_Divide_aj[0];
           ...
           */
          B = sqrtf(rtb_Gain + rtb_Integrator1_b);
           ...
           */
          B = rtb_Divide_aj[0] * D - rtb_Divide_aj[1] *
            rtb_TmpSignalConversionAtMath_0;
          ...
          rtb_Switch_f_idx_1 = rtb_TmpSignalConversionAtMath_0 * rtb_Divide_aj[0]
            + D * rtb_Divide_aj[1];

          /* Trigonometry: '<S54>/Acos' incorporates:
           *  DotProduct: '<S54>/Dot Product'
           */
           ...
           *  Trigonometry: '<S54>/Acos'
           */
          B *= acosf(rtb_Switch_f_idx_1);
           ...
           */
          FMS_B.Merge = 2.0F * rtb_Gain * arm_sin_f32(B) / fminf(FMS_PARAM.L1,
            fmaxf(sqrtf(rtb_P_i_idx_0 + rtb_MathFunction_k[0]), 0.5F)) *
            FMS_PARAM.AY_P;
...
void FMS_init(void)
{
  ...
  /* SystemInitialize for Atomic SubSystem: '<S84>/Mission_SubSystem' */
  /* InitializeConditions for DiscreteIntegrator: '<S88>/Integrator1' */
  FMS_DW.Integrator1_DSTATE = 0.0F;

  /* InitializeConditions for DiscreteIntegrator: '<S88>/Integrator' */
  FMS_DW.Integrator_DSTATE = 0.0F;

  /* End of SystemInitialize for SubSystem: '<S84>/Mission_SubSystem' */
