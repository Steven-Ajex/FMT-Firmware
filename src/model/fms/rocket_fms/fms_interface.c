...
static param_t __param_list[] = {
    ...
    PARAM_FLOAT(VEL_XY_LIM, 2.0,false),
    PARAM_FLOAT(VEL_Z_LIM, 1.5, false),
    PARAM_FLOAT(YAW_P, 2.0, false),
