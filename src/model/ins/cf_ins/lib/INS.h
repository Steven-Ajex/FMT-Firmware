...
typedef struct {
  ...
  real32_T DiscreteTimeIntegrator5_DSTATE[2];/* '<S473>/Discrete-Time Integrator5' */
  real32_T DiscreteTimeIntegrator5_DSTAT_d[2];/* '<S474>/Discrete-Time Integrator5' */
  ...
  uint8_T DiscreteTimeIntegrator5_IC_LOAD;/* '<S473>/Discrete-Time Integrator5' */
  uint8_T DiscreteTimeIntegrator5_IC_LO_c;/* '<S474>/Discrete-Time Integrator5' */
...
struct Parameters_INS_T_ {
  ...
  real32_T Relay1_YOff_i;              /* Computed Parameter: Relay1_YOff_i
                                        * Referenced by: '<S401>/Relay1'
                                        */
  real32_T Gain1_Gain_lp;              /* Computed Parameter: Gain1_Gain_lp
  ...
  real32_T Gain_Gain_ca;               /* Computed Parameter: Gain_Gain_ca
                                        ...
                                        */
  real32_T Gain_Gain_iv;               /* Computed Parameter: Gain_Gain_iv
                                        * Referenced by: '<S470>/Gain'
                                        */
  real32_T DiscreteTimeIntegrator5_gainv_h;/* Computed Parameter: DiscreteTimeIntegrator5_gainv_h
                                            * Referenced by: '<S474>/Discrete-Time Integrator5'
                                            */
  real32_T Gain_Gain_e2;               /* Computed Parameter: Gain_Gain_e2
