 ...
 * C/C++ source code generated on : Fri Dec 26 22:52:22 2025
 *
...
#ifndef DEFINED_TYPEDEF_FOR_Hinge_angle_
#define DEFINED_TYPEDEF_FOR_Hinge_angle_
...
typedef struct {
  ...
  Hinge_angle Hinge_angle_g;           /* '<Root>/Hinge_angle' */
