...
#endif
#ifndef DUAL_IMU_ATT_LOG_PERIOD_MS
#define DUAL_IMU_ATT_LOG_PERIOD_MS 20
#endif
...
{
    static dual_imu_att_output_t data;
    static uint8_t have_data = 0;
    DEFINE_TIMETAG(dual_imu_att_log_tt, DUAL_IMU_ATT_LOG_PERIOD_MS);
    ...
    if (have_data && check_timetag(TIMETAG(dual_imu_att_log_tt))) {
